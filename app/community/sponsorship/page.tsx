...
const sponsorshipTiers = [
  {
    ...
    price: "$500",
    icon: Gift,
    benefits: ["Logo on website", "Social media mention", "Event booth access", "Community newsletter"],
  },
  {
    name: "Silver",
    price: "$2,500",
    icon: Star,
    benefits: ["All Bronze benefits", "Speaking opportunity", "Job board listing", "Quarterly newsletter feature"],
  },
  {
    name: "Gold",
    price: "$5,000",
  ...
  },
  {
    ...
    price: "Custom",
    icon: Zap,
    benefits: ["All Gold benefits", "Custom partnership plan", "Executive visibility", "Strategic collaboration"],
  },
]
    ...
    <div className="min-h-screen bg-background">
      <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold text-foreground md:text-5xl mb-4">Become a Sponsor</h1>
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Sponsorship Tiers */}
          <div className="mb-16">
            <h2 className="mb-8 text-3xl font-bold text-foreground">Sponsorship Packages</h2>
          ...
          <Card className="border border-border/50 p-8 bg-gradient-to-r from-accent/5 to-primary/5">
            <h2 className="mb-4 text-2xl font-bold text-foreground">Why Sponsor Django Rwanda?</h2>
            <ul className="space-y-3 text-foreground/70">
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>Reach 500+ active developers and tech professionals across Africa</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
                <span>Build brand recognition in the growing African tech ecosystem</span>
              </li>
              <li className="flex gap-3">
                <span className="text-primary">•</span>
