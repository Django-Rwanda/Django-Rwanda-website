    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-b from-accent/10 to-background py-12 md:py-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <Link href="/events" className="inline-flex items-center gap-1 text-primary hover:text-primary/80 mb-4">
            ← Back to Events
          </Link>
          <h1 className="text-4xl font-bold text-foreground md:text-5xl mb-4">{event.title}</h1>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 md:grid-cols-3">
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              <Card className="border border-border/50 p-8 bg-gradient-to-r from-accent/5 to-primary/5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground/60">Time</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-foreground/60">Attendees</p>
                      <p className="text-foreground">{event.attendees} people attending</p>
                    </div>
                  </div>
                </div>
              </Card>
              ...
              {/* Agenda */}
              <div>
                <h2 className="mb-6 text-2xl font-bold text-foreground">Agenda</h2>
                <div className="space-y-3">
                  {agenda.map((item, idx) => (
                    <Card key={idx} className="border border-border/50 p-4 flex items-center gap-4">
              ...
              <Card className="border border-border/50 p-8">
                <h2 className="mb-4 text-2xl font-bold text-foreground">What to Expect</h2>
                <ul className="space-y-3 text-foreground/70">
                  <li className="flex gap-3">
                    <span className="text-primary">•</span>
                    <span>Network with Django developers and tech enthusiasts from across the region</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">•</span>
                    <span>Learn from experienced speakers and community leaders</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">•</span>
                    <span>Discover job opportunities and collaboration possibilities</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-primary">•</span>
            ...
            <div className="space-y-6">
              ...
              <Card className="sticky top-24 border border-border/50 p-6">
                <h3 className="mb-4 font-bold text-foreground">Ready to attend?</h3>
                <Link href={`/register/events/${event.id}`} className="block mb-3">
                  <Button className="w-full bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90">
                    Register Now
                  </Button>
                </Link>
                <p className="text-xs text-foreground/60">Limited spots available</p>
              </Card>
