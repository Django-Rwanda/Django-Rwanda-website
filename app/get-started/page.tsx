...
const paths = [
  {
    ...
    description: "Master Django through comprehensive workshops and training programs",
  ...
  },
  {
    ...
    description: "Connect with other developers, attend events, and grow together",
    cta: "Join Us",
    href: "/community/join",
  },
  {
    ...
    description: "Help build open-source projects and solve real-world problems",
    cta: "Learn How",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-foreground md:text-5xl">Get Started with Django Rwanda</h1>
            <p className="max-w-2xl text-lg text-foreground/70">
              Choose your path and begin your journey with Django Rwanda Community
            </p>
          </div>
        </div>
      </section>
              ...
              return (
                <Link key={idx} href={path.href}>
                  <Card className="group h-full border border-border/50 p-8 transition-all hover:border-primary/50 hover:shadow-lg cursor-pointer flex flex-col bg-gradient-to-br from-background to-muted/30">
                    ...
                    <h3 className="mb-2 text-2xl font-bold text-foreground">{path.title}</h3>
                    <p className="mb-6 flex-1 text-foreground/70">{path.description}</p>
      ...
      <section className="border-t border-border bg-gradient-to-b from-muted to-background py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <h2 className="mb-8 text-center text-3xl font-bold text-foreground">Quick Start in 3 Steps</h2>
          <div className="grid gap-8 md:grid-cols-3">
            {[
              {
                step: "1",
                title: "Sign Up",
                description: "Create your free Django Rwanda Community account in minutes",
              },
              {
                step: "2",
              ...
              <div key={item.step} className="text-center">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-primary to-accent text-lg font-bold text-primary-foreground">
                  {item.step}
                </div>
