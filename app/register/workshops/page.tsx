    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="mx-auto w-full max-w-2xl px-4 py-8">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-foreground">Workshop Registration</h1>
          <p className="mt-2 text-foreground/60">Secure your spot in our next workshop</p>
        </div>
        ...
        <Card className="border border-border/50 p-8">
          <form className="space-y-6">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-foreground">Select Workshop</label>
            ...
            <div>
              ...
              <div className="space-y-2">
                {["Beginner", "Intermediate", "Advanced"].map((level) => (
                  <label key={level} className="flex items-center gap-2 text-foreground/60">
                    <input type="radio" name="experience" className="rounded border border-border" />
                    {level}
                  </label>
                ))}
              </div>
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-foreground">Additional Comments</label>
              <textarea
                rows={4}
                className="w-full rounded-lg border border-border bg-input px-4 py-2 text-foreground placeholder:text-foreground/40 focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <label className="flex items-center gap-2 text-sm text-foreground/60">
              ...
              <span>I agree to receive updates and notifications about the workshop</span>
            </label>
