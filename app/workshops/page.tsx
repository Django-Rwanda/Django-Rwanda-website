...
export const metadata = {
  ...
  description: "Comprehensive Django workshops from fundamentals to advanced patterns",
}
      ...
      <section className="bg-gradient-to-b from-primary/10 to-background py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-foreground md:text-5xl">Learning & Workshops</h1>
            ...
            {workshops.map((workshop) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col space-y-4 p-6">
                  <h2 className="text-2xl font-bold text-foreground">{workshop.title}</h2>
