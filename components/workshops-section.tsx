...
export function WorkshopsSection() {
  return (
    <section id="workshops" className="relative bg-gradient-to-b from-background to-muted py-20 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Section header */}
        <div className="mb-16 space-y-4">
          <h2 className="text-3xl font-bold text-foreground md:text-5xl">Learning & Workshops</h2>
          ...
          {workshops.map((workshop) => (
            ...
            >
              ...
              <div className="space-y-4 p-6">
                ...
                <p className="text-sm text-foreground/70">{workshop.description}</p>
