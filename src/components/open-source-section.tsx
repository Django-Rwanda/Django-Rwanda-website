...
export function OpenSourceSection() {
  return (
    <section id="open-source" className="relative py-20 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Contribution CTA */}
        <div className="mt-16 rounded-lg border border-primary/30 bg-gradient-to-r from-primary/5 to-primary-light/5 p-8 text-center md:p-12">
